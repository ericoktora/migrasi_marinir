    ...
    try:
        ...
        query = """
            INSERT INTO transaksi_paket_lab (
                id_transaksi_paket_lab, id_transaksi_lab, id_paket_lab, waktu, cito, id_harga_kultur,
                harga, created_at, updated_at
            ) VALUES (
                %(id_transaksi_paket_lab)s, %(id_transaksi_lab)s, %(id_paket_lab)s, %(waktu)s, %(cito)s, %(id_harga_kultur)s,
