...
query = """
    INSERT INTO tat (
        id_tat, id_transaksi_lab, waktu_cekin, mulai, akhir, created_at, updated_at
    ) VALUES (
        %(id_tat)s, %(id_transaksi_lab)s, %(waktu_cekin)s, %(mulai)s, %(akhir)s, %(created_at)s, %(updated_at)s
    )
"""
