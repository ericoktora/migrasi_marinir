...
for row in data_awal:
    try:
        ...
        query = """
            INSERT INTO ruangan (
                id_ruangan, kode, nama_ruangan, kode_his, kode_ruangan, created_at, updated_at
            ) VALUES (
                %(id_ruangan)s, %(kode)s, %(nama_ruangan)s, %(kode_his)s, %(kode_ruangan)s, %(created_at)s, %(updated_at)s
            )
        """
